...
SET CTRMAP_DIR=AddYourCTRMAPPath
SET OUTPUT_DIR=AddYourOutputPath
...
SET BATTL_UPG_ARM_SRC=%PATCHES_DIR%\%BATTL_UPG_PATCH%.S
...
SET BATTL_UPG_ARM_ELF=%BUILD_DIR%\%BATTL_UPG_PATCH%ARM.o
...
%GCC% %BATTL_UPG_ARM_SRC% -o %BATTL_UPG_ARM_ELF% %COMPILATION_FLAGS%
...
%LD% -r -o %OUTPUT_ELF% %GAME_VARS_ELF% %BATTL_UPG_ELF% %BATTL_UPG_ARM_ELF% %KOL_ITEMS_ELF% %KOL_ITEMS_ARM_ELF%
ECHO --- 
