...
struct BtlvInput_0x180
{
    _BYTE gap0[383];
    char field_17F;
};

struct BtlvInput_0x1E0
{
    _BYTE gap0[479];
    char field_1DF;
};
...
struct BtlvInput
{
    TCBManager* pTCBManager;
    TCBManager* pTCBManagerBlank;
    TCB* TCBArray[8];
    void(* TCBTasks[8])(TCB*);
    ...
    BtlType BattleType;
    unsigned int BottomScreenMenuState;
    MsgData* msgData;
    ...
    int Flags2;
    int field_70;
    BtlvInput_12 field_74[6];
    BtlvInput_12 field_BC[6];
    ...
    ClActWork* field_118;
    ClAct_228* field_11C[12];
    ClAct_228* field_14C[12];
    ClActWork* field_17C;
    ClAct_228* field_180[12];
    int field_1B0[3];
    int field_1BC;
    int field_1C0;
    ClActWork* field_1C4;
    ClAct_228* field_1C8[6];
    int MoveTypeIconNCGRs[4];
    int MoveTypeIconNCLR;
    int UIButtonSelectCursorNCER2;
    ClActWork* field_1F8;
    ClAct_228* field_1FC[4];
    ClActWork* field_20C;
    ClAct_228* field_210;
    ClAct_228* field_214;
    ClActWork* field_218;
    ...
    int field_288;
    BtlvInput_0x180* PokestarTheaterBGPalette;
    BtlvInput_0x1E0* PokestarTheaterPersonPalette;
    int field_294;
    int field_298;
    int field_29C;
    int field_2A0;
...
//struct SWAN_PACKED SWAN_ALIGNED(1) CalcDmgPokeData
//{
//    u8 substituteFlag : 1;
//    u8 fixedDamageFlag : 1;
//    u8 critFlag : 1;
//    u8 unknownFlag1 : 1;
//    u8 unknownFlag2 : 1;
//    u8 unknownFlag3 : 1;
...
struct SWAN_ALIGNED(4) HandlerParam_AddFieldEffect
{
    ...
    ConditionData cond;
    u8 fAddDependPoke;
    // terrain type when creating terrain
    char field_D;
    char field_E;
    char field_F;
    HandlerParam_StrParams exStr;
...
int ScaleExpGainedByLevel(BattleMon* a1, unsigned int a2, int a3, int a4);
...
void AddEVs(BattleMon* r0_0, BattleMon* a2, CalcExpWork* a3);
...
int sub_219F2EC(int a1, int a2);
int j_j_DeadRec_GetCount_1(FaintRecord* a1, unsigned int turn);
//a1 = unknown*
//a2 = a2a
//a3 = v28
int sub_219F2F4(int a1, int a2, int a3);
bool sub_21BDC48(int* a1);
int sub_219D3CC(int a1);
...
bool sub_21D0400();
void sub_21D03E0(int a1, unsigned int a2);
...
int BattleEventVar_GetValue(int battleEventVar);
unsigned int fixed_round(int a1, int a2);
...
int j_FaintRecord_GetCount(FaintRecord* a1, unsigned int turn);
int Handler_IsPosOpenForRevivedMon(ServerFlow* a1);
int ServerFlow_ReqChangePokeForServer(ServerFlow* a1, short* a2);
unsigned int ServerDisplay_IllusionSet(ServerFlow* a1, short* a2);
_DWORD* ServerControl_CheckActivation(ServerFlow* a1);
int sub_219FB7C(ServerFlow* a1, ActionOrderWork* a2, unsigned int a3);
int ActionOrder_Proc(ServerFlow* a1, ActionOrderWork* a2);
...
void ServerEvent_GetMoveParam(ServerFlow* a1, int a2, BattleMon* a3, MoveParam* a4);
...
BattleEventItem* MoveEvent_RemoveItem(BattleMon* a1, int moveID);
...
bool Handler_CheckMatchup(ServerFlow* a1);
...
void ServerControl_FieldEffectEnd(ServerFlow* serverFlow, FIELDEFFECT fieldEffect);
...
BattleEventItem* ItemEvent_AddItemCore(BattleMon* battleMon, int itemID);
void BattleEventItem_SetTempItemFlag(BattleEventItem* result);
u8 PML_MoveGetType(int wazaId);
void HandlerThiefStart(BattleEventItem* a1, ServerFlow* serverFlow, int pokemonSlot, int* work);
unsigned int MultiplyValueByRatio(int a1, int a2);
int HandlerCommon_IsUnremovableItem(int a1, int a2);
int ServerEvent_CheckItemSet(ServerFlow* serverFlow, BattleMon* currentMon, int itemID);
void ServerEvent_ItemSetFailed(ServerFlow* a1, BattleMon* a2);
BattleEventItem* BattleEvent_SeekItem(BattleEventItemType eventType, int pokemonSlot);
void BattleMon_CureMoveCondition(BattleMon* a1, MoveCondition a2);
int j_PosPoke_GetPokeExistPos(PosPoke* a1, int a2);
ConditionData Condition_MakePoke(int pokemonSlot);
void BattleField_RemoveDependPokeEffect(int pokemonSlot);
int BattleField_GetWeather();
int BattleField_GetWeatherTurns();
void BattleField_SetWeatherCore(BattleField* battleField, int weather, int turns);
void BattleViewCmd_AddAnim(int a1);
void BattleViewCmd_StartMessageStandard(BtlvCore* a1, int a2, _DWORD* a3);
int BattleViewCmd_WaitMessage(BtlvCore* a1);
void BattleField_EndWeather(BattleField* a1);
int GetTypeEffectiveness(int moveType, int pokemonType);
int j_j_Condition_CheckUnaffectedByType(ServerFlow* a1, BattleMon* a2);
void ServerEvent_CheckItemReaction(ServerFlow* a1, BattleMon* a2, int a3);
void ServerDisplay_SimpleHP(ServerFlow* serverFlow, BattleMon* currentMon, int damage, int sendCommand);
int BattleMon_GetSubstituteHP(BattleMon* a1);
int PokeTypePair_Make(__int16 a1, unsigned __int8 a2);
int PokeTypePair_GetType1(__int16 a1);
int PokeTypePair_GetType2(__int16 a1);
TypeEffectiveness ServerEvent_CheckDamageEffectiveness(ServerFlow* serverFlow,BattleMon* attackingMon,BattleMon* defendingMon,int moveType,unsigned __int8 pokemonType);
bool PokeTypePair_IsMonotype(int a1);
TypeEffectiveness GetTypeEffectivenessMultiplier(int a1, int a2);
void ServerDisplay_UseHeldItem(ServerFlow* a1, BattleMon* a2);
unsigned int DivideMaxHp(BattleMon* a1, unsigned int a2);

// DamageRoot definitions
void ServerControl_DamageProcessingStart(ServerFlow* a1, BattleMon* a2, MoveParam* a3);
void j_PokeSet_Clear(const void* a1);
int ServerEvent_CheckMultihitHits(ServerFlow* a1, BattleMon* a2, int a3, HitCheckParam* a4);
void ServerControl_ApplyDamageToRecover(ServerFlow* a1, BattleMon* a2, MoveParam* a3, PokeSet* a4);
int j_PokeSet_GetCount(PokeSet* a1);
int j_PokeSet_GetCountMax(PokeSet* a1);
int HitCheck_IsMultiHitMove(HitCheckParam* a1);
int ServerControl_DamageMultiCount(ServerFlow* a1, MoveParam* a2, BattleMon* a3, PokeSet* a4, EffectivenessRecorder* a5);
int ServerControl_CalcRecoil(ServerFlow* a1, BattleMon* a2, int a3, int a4);
int ServerControl_DamageSingleCount(ServerFlow* a1, MoveParam* a2, BattleMon* a3, PokeSet* a4, EffectivenessRecorder* a5, int* a6, int a7);
void ServerControl_DamageProcessingEnd(ServerFlow* serverFlow, MoveParam* moveParam, BattleMon* attackingMon, PokeSet* targetSet, int damage, int a6);
BtlType Handler_GetBattleType(ServerFlow* a1);
u16 PML_MoveGetBasePower(int wazaId);

// ServerControl_ChangeHeldItem
void ServerEvent_ItemSetDecide(ServerFlow* a1, BattleMon* a2, int a3);
void ItemEvent_RemoveItem(BattleMon* a1);
void BattleMon_SetItem(BattleMon* result, short a2);
BattleEventItem* ItemEvent_AddItem(BattleMon* a1);
void ServerEvent_ItemRewriteDone(ServerFlow* a1, BattleMon* a2);
void BattleMon_ConsumeItem(BattleMon* result, short a2);
void ServerDisplay_SetTurnFlag(ServerFlow* a1, BattleMon* a2, TurnFlag a3);
